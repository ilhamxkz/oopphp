...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="/">Admin Kantor</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item"><a class="nav-link" href="{{ route('rating.index') }}">Rating</a></li>
        <li class="nav-item"><a class="nav-link" href="{{ route('lembur.index') }}">Lembur</a></li>
